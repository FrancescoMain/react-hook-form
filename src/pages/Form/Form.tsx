...
import { Container, Main, Box, Side, Wrap } from "./style";
...
import UiUploadImage from "../../components/Ui/UiUploadImage/UiUploadImage";
      ...
      <Container>
        <form onSubmit={handleSubmit(onSubmit)}>
          <Wrap>
            ...
            <Side>
              <UiUploadImage register={register("image")} />
            </Side>
          </Wrap>
          <input type="submit" />
        </form>
